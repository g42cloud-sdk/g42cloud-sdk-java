...
public final class Constants {
    ...
    public static final String DEFAULT_IAM_ENDPOINT = "https://iam.ae-ad-1.g42cloud.com";

    public static final String IAM_ENDPOINT_ENV_NAME = "G42CLOUD_SDK_IAM_ENDPOINT";
